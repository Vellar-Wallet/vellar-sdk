...
HTTP-402 resources, and [agent keys](./agent-tooling/agent-keys.md) to let an agent pay on its
...
> take roughly 45 seconds (measured)** while it wakes. Allow up to 120 seconds
> in your timeout and retry rather than assuming a bug.
