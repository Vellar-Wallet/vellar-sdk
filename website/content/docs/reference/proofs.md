...
That hash is what builds reproducibly from the vendored source at
`contracts/upto-stellar/` in the facilitator repo. The source is credited to
rail402 (Apache-2.0) and vendored verbatim. See [upto](../upto.md).
